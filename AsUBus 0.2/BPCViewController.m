...
- (void)initAds
{
    ...
    {
        //But really this is redundant as the only reason
        //it would enter here is no internet connection,
        //and we already checked for that eh?
        NSLog(@"CRASH AND BURN MUAHAHAHAHAHAHA");
    }
